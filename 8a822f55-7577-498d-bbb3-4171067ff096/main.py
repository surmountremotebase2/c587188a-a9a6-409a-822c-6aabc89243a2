    ...
    def run(self, data):
        ...
        for ticker in self.tickers:
            ...
            buy_conditions_met = sum([
                current_ema9 > current_ema21 and current_rsi < 45,
                #current_ema9 > current_ema21 and current_rsi > 60,  # More aggressive bullish confirmation
                current_macd > current_signal and current_rsi < 50,  # RSI below 30 and MACD crosses above signal line
                #current_macd > current_signal and current_rsi > 60,  # MACD crosses above signal line and RSI > 55
                current_close <= current_bb_lower and current_rsi < 40,  # Price below lower Bollinger Band
                current_slope_value > 0 and current_momentum_value > 0 and current_rsi < 50  # Positive slope and increasing momentum
            ])
            ...
            sell_conditions_met = sum([
                ...
                current_macd < current_signal and current_rsi < 50,  # MACD crosses below signal line and RSI < 45
                current_close >= current_bb_upper and current_rsi > 65,  # Price above upper Bollinger Band and RSI > 70
                current_slope_value < 0 and current_momentum_value < 0 and current_rsi < 45  # Negative slope and weakening momentum
                
            ])

            if current_adx > 20 and current_ema21 > current_ema9 and current_macd < current_signal: 
                if sell_conditions_met >= 2:
                    ...
                    elif current_time >= self.sell_condition_times[ticker] + timedelta(minutes=0):
