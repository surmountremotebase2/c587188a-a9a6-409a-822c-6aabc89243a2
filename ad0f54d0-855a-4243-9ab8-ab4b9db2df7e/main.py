...
class TradingStrategy(Strategy):
    def __init__(self):
        ...
        # Allocation dict to track positions for each asset
    ...
    def run(self, data):
        ...
        for ticker in self.tickers:
            ...
            # Check if macd_data is properly returned and contains sufficient data
            if macd_data and 'macd' in macd_data and 'signal' in macd_data:
                ...
                log(f"No valid MACD data for {ticker}")
