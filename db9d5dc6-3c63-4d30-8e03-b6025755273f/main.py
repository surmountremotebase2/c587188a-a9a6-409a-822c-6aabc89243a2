...
class TradingStrategy(Strategy):
    ...
    def run(self, data):
        ...
        for ticker in self.tickers:
            ...
            if ((current_macd > current_signal and current_ema9 > current_ema21 and current_rsi < 45) or  # 1st condition
            ...
            elif ((current_signal > current_macd and current_ema21 > current_ema9 and current_rsi > 55) or  # 1st condition
