        ...
        if len(data["ohlcv"]) > 26:  # Ensure enough data for indicators
            for ticker in self.tickers:
                ...
                if macd_line and signal_line:
                    if previous_signal > previous_macd and current_macd > current_signal and current_rsi < 45: #and (current_macd - current_signal) < 0 and current_mfi < 30 and current_adx > 40 and current_cci < 0:  # Buy condition 1
                    ...
                    elif bb_lower and current_close < bb_lower and current_rsi < 70  and current_adx > 45: # and current_mfi < 20 and current_adx > 45 and current_cci < -150:  # Buy condition 5
                ...
                if macd_line and signal_line and self.holding_dict[ticker] > 0:
                    if (current_signal > current_macd) and (previous_macd > previous_signal) and current_rsi > 55: # and (current_signal - current_macd) > 0 and current_mfi > 70 and current_adx > 40 and current_cci > 0:  # Sell condition 1
                    ...
                    elif bb_upper and current_close > bb_upper and current_rsi > 70 and current_adx > 45: # and current_mfi > 70 and current_cci > 150:  # Sell condition 5
